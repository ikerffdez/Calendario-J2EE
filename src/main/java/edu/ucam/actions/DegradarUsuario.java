...
public class DegradarUsuario extends Actions{
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws SQLException {
		...
		if(usuarios!=null && email!=null) {
			if(request.getSession().getAttribute(Constantes.ROL).equals(Rol.ADMIN)) {
				...
				Singleton.getUsuarioDAO().degradarUsuario(usuario);
			...
			request.setAttribute(Constantes.MENSAJE_ERROR, "Ha sido imposible degradar al usuario");
		}
